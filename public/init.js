...
var TRANSLATIONS = {
  en: {
    ...
    ent_li6: 'SLA',
    // ─── Pay-per-Request ───
    plan_ppr_badge: 'Coming Soon',
    plan_ppr_name: 'Pay-per-Request API',
    plan_ppr_per: '–$0.005/req',
    plan_ppr_usage: 'No monthly commitment · Perfect for AI agents',
    ppr_li1: 'Basic request: $0.001',
    ppr_li2: 'Cloudflare/JS-heavy: $0.005',
    ppr_li3: 'CAPTCHA solve: $0.003',
    ppr_li4: 'Pay with USDT, ETH, BTC, SOL, or card',
    ppr_li5: 'Auto-purchase: agents buy their own credits',
    ppr_notify_btn: '🔔 Notify me when ready',
    // ─── Add-ons ───
    ...
    addon_5_price: '$2.99',
    // ─── Affiliate ───
    affiliate_desc: 'Using a different proxy? Get residential proxies via our affiliate links — same quality backbone we use. We earn a small commission at no cost to you.',
    affiliate_decodo: 'Get Decodo Residential Proxies →',
    affiliate_iproyal: 'Get IPRoyal Proxies →',
    // ─── Free vs Paid ───
  ...
  ru: {
    ...
    ent_li6: 'SLA',
    // ─── Pay-per-Request ───
    plan_ppr_badge: 'Скоро',
    plan_ppr_name: 'Pay-per-Request API',
    plan_ppr_per: '–$0.005/запрос',
    plan_ppr_usage: 'Без ежемесячной платы · Для AI-агентов',
    ppr_li1: 'Базовый запрос: $0.001',
    ppr_li2: 'Cloudflare/JS-heavy: $0.005',
    ppr_li3: 'Решение CAPTCHA: $0.003',
    ppr_li4: 'Оплата USDT, ETH, BTC, SOL или картой',
    ppr_li5: 'Автопокупка: агенты сами пополняют баланс',
    ppr_notify_btn: '🔔 Уведомить меня о запуске',
    // ─── Add-ons ───
    ...
    addon_5_price: '$2.99',
    // ─── Affiliate ───
    affiliate_desc: 'Используете другой прокси? Получите резидентные прокси через наши партнёрские ссылки — тот же бэкбон, что используем мы. Мы получаем комиссию, для вас это бесплатно.',
    affiliate_decodo: 'Получить Decodo Residential Proxies →',
    affiliate_iproyal: 'Получить IPRoyal Proxies →',
    // ─── Free vs Paid ───
  ...
  es: {
    ...
    addon_5_price: '$2.99',
    // ─── Affiliate ───
    affiliate_desc: '¿Usando otro proxy? Obtén proxies residenciales a través de nuestros enlaces de afiliado — la misma red que usamos nosotros. Ganamos una pequeña comisión sin coste para ti.',
    affiliate_decodo: 'Obtener Decodo Residential Proxies →',
    affiliate_iproyal: 'Obtener IPRoyal Proxies →',
    // ─── Free vs Paid ───
  ...
  zh: {
    ...
    addon_5_price: '$2.99',
    // ─── Affiliate ───
    affiliate_desc: '使用其他代理？通过我们的联盟链接获取住宅代理——与我们使用的同等品质骨干网络。我们赚取少量佣金，对您零额外费用。',
    affiliate_decodo: '获取Decodo住宅代理 →',
    affiliate_iproyal: '获取IPRoyal代理 →',
    // ─── Free vs Paid ───
    fvp_eyebrow: '包含内容',
