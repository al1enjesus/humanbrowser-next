...
var TRANSLATIONS = {
  en: {
    ...
    code_c3: 'Romanian IP · iPhone 15 fingerprint · webdriver=false',
    // ─── Callout ───
    ...
    callout_li3: 'iPhone 15 Pro UA · Romania IP · Bucharest geolocation',
    ...
    feat_1_h: 'Romania Residential IP',
    feat_1_p: 'DIGI Romania & WS Telecom ISP. Real residential ASN. Looks like a person browsing from Bucharest.',
    ...
    plan_starter_usage: '2 GB bandwidth · $2.50/GB after',
    plan_pro_usage: '20 GB bandwidth · $2.00/GB after',
    plan_ent_usage: 'Unlimited · Dedicated zone',
    starter_li1: 'Romania residential IP',
    starter_li2: 'iPhone 15 Pro + Desktop',
    starter_li3: 'OpenClaw skill + credentials',
    starter_li4: 'Cloudflare / DataDome bypass',
    starter_li5: 'Email support',
    starter_li_off1: 'Multi-country rotation',
    starter_li_off2: 'CDP / Scraping Browser',
    pro_li1: 'Everything in Starter',
    pro_li2: 'Multi-country IP rotation',
    pro_li3: 'Scraping Browser CDP access',
    pro_li4: 'Custom fingerprints',
    pro_li5: 'Agent-native payment API',
    pro_li6: 'Priority support',
    ent_li1: 'Everything in Pro',
    ent_li2: 'Dedicated Romania zone',
    ent_li3: 'White-label API endpoint',
    ent_li4: '1-on-1 onboarding call',
    ent_li5: 'SLA guarantee',
    ent_li6: 'Custom skill development',
    // ─── Free vs Paid ───
    ...
    free_li7: '⚠️ You need your own residential proxy',
    ...
    paid_li1: '✅ Romania / US / UK / DE / NL / JP IPs',
    paid_li2: '✅ Real residential ISP (DIGI, AT&T, BT…)',
    paid_li3: '✅ Instant credential delivery after payment',
    ...
    faq_4a: 'Card payments via Stripe: 2–3 minutes. Crypto (USDT/ETH): 5–10 minutes after on-chain confirmation. AI agent API: fully automatic, no human in the loop.',
  ...
  ru: {
    ...
    code_c3: 'Румынский IP · фингерпринт iPhone 15 · webdriver=false',
    // ─── Callout ───
    ...
    callout_li3: 'UA iPhone 15 Pro · IP Румынии · геолокация Бухарест',
    ...
    feat_1_h: 'Резидентный IP Румынии',
    feat_1_p: 'DIGI Romania и WS Telecom ISP. Настоящий резидентный ASN. Выглядит как человек, сидящий в сети из Бухареста.',
    ...
    plan_starter_usage: '2 ГБ трафика · $2.50/ГБ сверх лимита',
    plan_pro_usage: '20 ГБ трафика · $2.00/ГБ сверх лимита',
    plan_ent_usage: 'Безлимит · Выделенная зона',
    starter_li1: 'Резидентный IP Румынии',
    starter_li2: 'iPhone 15 Pro + Desktop',
    starter_li3: 'Скилл OpenClaw + credentials',
    starter_li4: 'Обход Cloudflare / DataDome',
    starter_li5: 'Поддержка по email',
    starter_li_off1: 'Ротация по странам',
    starter_li_off2: 'CDP / Scraping Browser',
    pro_li1: 'Всё из Starter',
    pro_li2: 'Ротация IP по странам',
    pro_li3: 'Доступ к Scraping Browser CDP',
    pro_li4: 'Кастомные фингерпринты',
    pro_li5: 'Агентный платёжный API',
    pro_li6: 'Приоритетная поддержка',
    ent_li1: 'Всё из Pro',
    ent_li2: 'Выделенная зона Румынии',
    ent_li3: 'White-label API endpoint',
    ent_li4: 'Созвон 1-на-1 при онбординге',
    ent_li5: 'Гарантия SLA',
    ent_li6: 'Разработка кастомных скиллов',
    // ─── Free vs Paid ───
    ...
    paid_li1: '✅ IP Румынии / США / Великобритании / DE / NL / JP',
    ...
    faq_4a: 'Оплата картой через Stripe: 2–3 минуты. Крипта (USDT/ETH): 5–10 минут после on-chain подтверждения. API AI-агента: полностью автоматически, без человека в процессе.',
  ...
  es: {
    ...
    code_c3: 'IP rumana · huella iPhone 15 · webdriver=false',
    // ─── Callout ───
    ...
    callout_li3: 'UA iPhone 15 Pro · IP Romania · geolocalización Bucarest',
    ...
    feat_1_h: 'IP Residencial de Romania',
    feat_1_p: 'ISP DIGI Romania y WS Telecom. ASN residencial real. Parece una persona navegando desde Bucarest.',
    ...
    plan_starter_usage: '2 GB de ancho de banda · $2.50/GB adicional',
    plan_pro_usage: '20 GB de ancho de banda · $2.00/GB adicional',
    plan_ent_usage: 'Ilimitado · Zona dedicada',
    starter_li1: 'IP residencial de Romania',
    starter_li2: 'iPhone 15 Pro + Escritorio',
    starter_li3: 'Skill OpenClaw + credenciales',
    starter_li4: 'Bypass Cloudflare / DataDome',
    starter_li5: 'Soporte por email',
    starter_li_off1: 'Rotación multi-país',
    starter_li_off2: 'CDP / Scraping Browser',
    pro_li1: 'Todo lo de Starter',
    pro_li2: 'Rotación de IPs multi-país',
    pro_li3: 'Acceso CDP Scraping Browser',
    pro_li4: 'Huellas personalizadas',
    pro_li5: 'API de pago nativa para agentes',
    pro_li6: 'Soporte prioritario',
    ent_li1: 'Todo lo de Pro',
    ent_li2: 'Zona dedicada Romania',
    ent_li3: 'Endpoint API white-label',
    ent_li4: 'Llamada de onboarding 1-a-1',
    ent_li5: 'Garantía SLA',
    ent_li6: 'Desarrollo de skills personalizados',
    // ─── Free vs Paid ───
  ...
  zh: {
    ...
    code_c1: '自然滚动带随机抖动',
    code_c2: '60–220毫秒/字符',
    code_c3: '罗马尼亚IP · iPhone 15指纹 · webdriver=false',
    // ─── Callout ───
    ...
    callout_li3: 'iPhone 15 Pro UA · 罗马尼亚IP · 布加勒斯特地理位置',
    ...
    feat_1_h: '罗马尼亚住宅IP',
    feat_1_p: 'DIGI Romania和WS Telecom ISP，真实住宅ASN，看起来就像一个在布加勒斯特上网的普通人。',
    ...
    plan_pop_tag: '最受欢迎',
    plan_starter_usage: '2 GB带宽 · 超出$2.50/GB',
    plan_pro_usage: '20 GB带宽 · 超出$2.00/GB',
    plan_ent_usage: '无限制 · 专属区域',
    starter_li1: '罗马尼亚住宅IP',
    starter_li2: 'iPhone 15 Pro + 桌面',
    starter_li3: 'OpenClaw技能 + 凭据',
    starter_li4: 'Cloudflare / DataDome 绕过',
    starter_li5: '邮件支持',
    starter_li_off1: '多国IP轮换',
    starter_li_off2: 'CDP / 爬取浏览器',
    pro_li1: '包含Starter全部功能',
    pro_li2: '多国IP轮换',
    pro_li3: '爬取浏览器CDP访问',
    pro_li4: '自定义指纹',
    pro_li5: '代理原生支付API',
    ...
    pm1_s3: '付款 → 凭据立即交付',
    pm2_h: 'USDT (TRC-20 或 ERC-20)',
    pm2_p: '最受欢迎的加密选项。精确金额发送到钱包地址。0xProcessing自动确认。',
    pm2_s1: '点击「立即开始」→ 选择USDT',
    pm2_s2: '获取钱包地址和精确金额',
    pm2_s3: '发送 → 约2分钟获得凭据',
    pm3_h: 'Solana / ETH / BTC',
