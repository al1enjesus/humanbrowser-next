...
var TRANSLATIONS = {
  en: {
    ...
    affiliate_desc: 'We earn a small affiliate commission on these links — same providers we partner with. No extra cost to you.',
  ...
  ru: {
    ...
    affiliate_desc: 'Мы получаем небольшую партнёрскую комиссию с этих ссылок — те же провайдеры, с которыми мы работаем. Для вас это бесплатно.',
  ...
  es: {
    ...
    affiliate_desc: 'Ganamos una pequeña comisión de afiliado con estos enlaces — los mismos proveedores con los que trabajamos. Sin coste adicional para ti.',
  ...
  zh: {
    ...
    affiliate_desc: '我们通过这些链接获得少量联盟佣金——均为我们合作的代理商，对您无额外费用。',
